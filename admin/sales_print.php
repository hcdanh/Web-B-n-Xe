<?php
	...
	if(isset($_POST['print'])){
	    ...
	    $content .= '
	      	...
	      	<h4 align="center">Chi tiết đơn</h4>
	      	<h4 align="center">'.$from_title." - ".$to_title.'</h4>
	      	<table border="1" cellspacing="0" cellpadding="3">  
	           <tr>  
	           		<th width="15%" align="center"><b>Ngày</b></th>
	                <th width="30%" align="center"><b>Người mua</b></th>
					<th width="40%" align="center"><b>Mã giao dịch</b></th>
					<th width="15%" align="center"><b>Số lượng</b></th>  
	           </tr>  
	      ';  
		...
		$_SESSION['error'] = 'Cần cung cấp khoảng thời gian để in đơn';
